{{--
  ...
  - Renders everywhere in admin layout
  - JS lives in resources/js/admin/ai-popup.js
--}}

<div id="impart-ai-assist" class="fixed bottom-5 right-5 z-[9999]" data-admin-base="{{ url('/' . trim(config('cms.admin_path', 'admin'), '/')) }}">
    <button type="button"
