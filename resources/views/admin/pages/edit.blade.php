                                ...
                                <div class="lg:sticky lg:top-6 space-y-4">
                                    <div class="rounded-lg border border-gray-200 bg-white p-4">
                                        <div class="flex items-center justify-between">
                                            ...
                                            <span class="text-xs font-semibold uppercase tracking-widest px-2 py-1 rounded border
                                                {{ $page->status === 'published' ? 'bg-green-50 text-green-800 border-green-200' : 'bg-yellow-50 text-yellow-800 border-yellow-200' }}">
                                                {{ strtoupper($page->status) }}
                                            </span>
                                        </div>
                                                ...
                                                <div class="mt-4 border-t pt-4">
                                                    ...
                                                    <div class="mt-3 grid grid-cols-1 gap-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <input type="text" name="twitter_image_url"
                                    ...
                                    <div class="rounded-lg border border-red-200 bg-red-50 p-4">
                                        ...
                                        <p class="text-xs text-red-700/80 mt-1">Delete this page permanently.</p>
