                            ...
                            <div class="space-y-6">
                                ...
                                <div class="hidden lg:block">
                                    <div class="rounded-lg border border-gray-200 bg-white p-4">
                                        ...
                                        <div class="mt-4 flex flex-col gap-2">
                                            @if($page->status === 'published')
                                                <a href="{{ url('/' . ltrim($page->slug, '/')) }}"
                                                   target="_blank"
                                                   class="inline-flex items-center justify-center px-4 py-2 bg-white border border-gray-300 rounded-md font-semibold text-xs text-gray-900 hover:bg-gray-50">
                                                    View Live
                                                </a>
                                            @else
                                                <a href="{{ route('pages.preview', $page) }}"
                                            ...
                                            @if($page->status === 'published')
                                                ...
                                                @else
                                                    <form method="POST" action="{{ route('admin.pages.setHomepage', $page) }}"
                                                        ...
                                                        @csrf
                                                        <button type="submit"
                                                                class="inline-flex w-full items-center justify-center px-4 py-2 bg-white border border-gray-300 rounded-md font-semibold text-xs text-gray-900 hover:bg-gray-50">
                                                            Set as Homepage
                                                        </button>
                                                    </form>
                                                @endif
                                            ...
                                            @if($page->status === 'published')
                                                <button type="submit" form="page-form" name="action" value="publish"
                                                        class="inline-flex items-center justify-center px-4 py-2 bg-gray-900 text-white rounded-md font-semibold text-xs hover:bg-gray-800">
                                                    Update
                                                </button>
                                    ...
                                    @if(isset($headerBlocks) && isset($footerBlocks))
                                        <div class="rounded-lg border border-gray-200 bg-white p-4">
                                            ...
                                            <p class="mt-1 text-xs text-gray-500">If set, overrides the global matching header/footer for this page.</p>
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <select name="header_block_id" class="mt-1 w-full rounded-md border-gray-300">
                                                    ...
                                                    @foreach($headerBlocks as $b)
                                                        <option value="{{ $b->id }}" {{ (old('header_block_id', $page->header_block_id) == $b->id) ? 'selected' : '' }}>
                                                            {{ $b->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <select name="footer_block_id" class="mt-1 w-full rounded-md border-gray-300">
                                                    ...
                                                    @foreach($footerBlocks as $b)
                                                        <option value="{{ $b->id }}" {{ (old('footer_block_id', $page->footer_block_id) == $b->id) ? 'selected' : '' }}>
                                                            {{ $b->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="rounded-lg border border-gray-200 bg-white p-4" id="seo-panel">
                                        ...
                                        <div class="mt-3 flex flex-wrap gap-2" role="tablist" aria-label="SEO tabs">
                                            <button type="button" data-seo-tab="general"
                                                    class="seo-tab-btn inline-flex items-center px-3 py-1.5 rounded-md text-xs font-semibold border bg-gray-900 text-white border-gray-900">
                                                General
                                            </button>
                                            <button type="button" data-seo-tab="social"
                                                    class="seo-tab-btn inline-flex items-center px-3 py-1.5 rounded-md text-xs font-semibold border bg-white text-gray-700 border-gray-300 hover:bg-gray-50">
                                                Social
                                            </button>
                                        ...
                                        <div class="mt-4 space-y-4">
                                            ...
                                            <div class="seo-tab hidden" data-seo-tab-panel="social">
                                                ...
                                                <div class="mt-4 border-t pt-4">
                                                    <h4 class="text-xs font-semibold text-gray-700">Twitter</h4>
                                ...
                                <div class="rounded-lg border border-red-200 bg-red-50 p-4">
                                    ...
                                    @if($page->is_homepage)
                                        ...
                                        <button type="button"
                                                class="mt-3 w-full inline-flex items-center justify-center px-4 py-2 bg-red-300 text-white rounded-md font-semibold text-xs cursor-not-allowed"
                                                disabled>
                                            Move to Trash
                                        </button>
                                    @else
                                        ...
                                        <form method="POST" action="{{ route('admin.pages.destroy', $page) }}"
                                            ...
                                            <button type="submit"
                                                    class="w-full inline-flex items-center justify-center px-4 py-2 bg-red-600 text-white rounded-md font-semibold text-xs hover:bg-red-700">
                                                Move to Trash
                                            </button>
                                        </form>
                                    @endif
