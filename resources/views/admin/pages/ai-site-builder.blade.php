            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 space-y-6">
                    ...
                    @if(($step ?? 'input') === 'input')
                        ...
                        <form method="POST" action="{{ route('admin.site-builder.blueprint') }}" class="space-y-5">
                            @csrf
                            ...
                            <div>
                                ...
                                <textarea name="notes" rows="5" class="mt-1 w-full rounded-md border-gray-300" placeholder="Any must-have pages, services, offers, brand personality, keywords, etc.">{{ old('notes', $input['notes'] ?? '') }}</textarea>
                            </div>
