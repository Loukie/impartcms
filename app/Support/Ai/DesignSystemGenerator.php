...
class DesignSystemGenerator
{
    ...
    private function normalizeDesignSystem(array $design): array
    {
        $defaults = [
            ...
            'hero_treatment' => 'Full-bleed image with dark gradient overlay, large serif heading, subtle ken-burns animation',
            'section_rhythm' => 'Varied layout types: hero, feature ribbon, alternating image-text cards, full-width split CTA, testimonial dark band, stats row',
            'spacing_density' => 'airy',
            'visual_mood' => 'premium-professional',
            'contrast_approach' => 'High contrast with dark hero, white content sections, and dark testimonial/CTA bands for visual rhythm',
            'typography_scale' => 'Dramatic heading scale with clamp(2.5rem, 5vw, 4rem) h1, clamp(1.8rem, 3vw, 2.5rem) h2, 1.05rem body',
            'section_backgrounds' => 'White content sections with dark-background feature bands and accent-colored CTA sections for variety',
