...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <form method="POST" action="<?php echo e(route('admin.layout-blocks.bulk')); ?>" id="bulkForm" onsubmit="return confirm('Move selected blocks to trash?');">
                <?php echo csrf_field(); ?>
                <div class="mb-3 p-4">
                ...
                <div class="bg-white shadow-sm sm:rounded-lg border border-gray-200 overflow-hidden">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $blocks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td class="px-6 py-4">
                                <input type="checkbox" name="ids[]" value="<?php echo e($b->id); ?>" class="bulk-checkbox" />
                            </td>
                            <td class="px-6 py-4">
