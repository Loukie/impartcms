...
<?php $component->withAttributes([]); ?>
        ...
        <div class="flex items-center justify-between">
            <div>
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                    <?php echo e($isNew ? 'New form' : 'Edit form'); ?>

                </h2>
                <div class="text-xs text-gray-500 mt-1">Shortcode: <code class="px-1 py-0.5 bg-gray-100 rounded">[form slug=&quot;<?php echo e($form->slug ?: 'your-slug'); ?>&quot;]</code></div>
            </div>
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="<?php echo e($isNew ? route('admin.forms.store') : route('admin.forms.update', $form)); ?>">
                <?php echo csrf_field(); ?>
                <?php if(!$isNew): ?>
                        ...
                        <div class="lg:col-span-2 space-y-6">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="slug" value="<?php echo e(old('slug', $form->slug)); ?>" class="mt-1 w-full rounded-md border-gray-300" required>
                                </div>
                            </div>

                            <label class="inline-flex items-center gap-2">
                                <input type="checkbox" name="is_active" value="1" class="rounded border-gray-300" <?php echo e(old('is_active', $form->is_active) ? 'checked' : ''); ?>>
                            ...
                            <div id="impart-forms-builder" data-initial='<?php echo json_encode($initial, 15, 512) ?>' class="border border-slate-200 rounded-xl overflow-hidden">
                                ...
                                <input type="hidden" name="fields_json" value='<?php echo json_encode($form->fields ?? [], 15, 512) ?>'>
                                <input type="hidden" name="settings_json" value='<?php echo json_encode($form->settings ?? [], 15, 512) ?>'>
                            </div>
                        </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="rounded-lg border border-gray-200 bg-white p-4">
                                ...
                                <div class="mt-2 text-xs text-gray-700">
                                    ...
                                    <code class="block p-2 bg-gray-50 rounded border">[form slug=&quot;<?php echo e($form->slug ?: 'your-slug'); ?>&quot;]</code>
                                    <div class="mt-3 mb-2">Override recipients:</div>
                                    <code class="block p-2 bg-gray-50 rounded border">[form slug=&quot;<?php echo e($form->slug ?: 'your-slug'); ?>&quot; to=&quot;you@email.com&quot;]</code>
                                </div>
                            </div>
            ...
            <?php if(!$isNew): ?>
                <form id="delete-form" method="POST" action="<?php echo e(route('admin.forms.destroy', $form)); ?>" class="hidden">
                    <?php echo csrf_field(); ?>
