<div class="bg-white border rounded-xl p-4">
    ...
    <div id="impart-icon-library" class="mt-4" data-mode="<?php echo e(request()->routeIs('admin.media.index') ? 'copy' : 'select'); ?>">
...
<?php /**PATH C:\laragon\www\2kocms\resources\views/admin/media/partials/fa-icons.blade.php ENDPATH**/ ?>