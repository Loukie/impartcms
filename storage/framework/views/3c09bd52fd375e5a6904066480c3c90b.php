...
<div class="min-h-screen flex">
    ...
    <aside class="w-64 bg-slate-950 text-white flex-shrink-0 border-r border-white/5">
        ...
        <nav class="p-3 space-y-1">
            ...
            <a href="<?php echo e(route('dashboard')); ?>" class="<?php echo e($linkBase); ?> <?php echo e($isActive('dashboard') ? $linkActive : $linkInactive); ?>">
                <svg class="h-4 w-4 flex-none <?php echo e($isActive('dashboard') ? $iconActive : $iconInactive); ?>" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            ...
            <a href="<?php echo e(url('/')); ?>" target="_blank" rel="noopener" class="<?php echo e($linkBase); ?> <?php echo e($linkInactive); ?>">
                <svg class="h-4 w-4 flex-none <?php echo e($iconInactive); ?>" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            ...
            <a href="<?php echo e(route('admin.pages.index')); ?>" class="<?php echo e($linkBase); ?> <?php echo e($isActive('admin.pages.*') ? $linkActive : $linkInactive); ?>">
                <svg class="h-4 w-4 flex-none <?php echo e($isActive('admin.pages.*') ? $iconActive : $iconInactive); ?>" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            ...
            <?php if(\Illuminate\Support\Facades\Route::has('admin.site-builder.create')): ?>
                <a href="<?php echo e(route('admin.site-builder.create')); ?>" class="<?php echo e($linkBase); ?> <?php echo e($isActive('admin.site-builder.*') ? $linkActive : $linkInactive); ?>">
                    <svg class="h-4 w-4 flex-none <?php echo e($isActive('admin.site-builder.*') ? $iconActive : $iconInactive); ?>" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            ...
            <?php if(\Illuminate\Support\Facades\Route::has('admin.ai.visual-audit')): ?>
                <a href="<?php echo e(route('admin.ai.visual-audit')); ?>" class="<?php echo e($linkBase); ?> <?php echo e($isActive('admin.ai.visual-audit*') ? $linkActive : $linkInactive); ?>">
                    <svg class="h-4 w-4 flex-none <?php echo e($isActive('admin.ai.visual-audit*') ? $iconActive : $iconInactive); ?>" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            ...
            <?php if(\Illuminate\Support\Facades\Route::has('admin.users.index')): ?>
                <a href="<?php echo e(route('admin.users.index')); ?>" class="<?php echo e($linkBase); ?> <?php echo e($isActive('admin.users.*') ? $linkActive : $linkInactive); ?>">
                    <svg class="h-4 w-4 flex-none <?php echo e($isActive('admin.users.*') ? $iconActive : $iconInactive); ?>" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            ...
            <?php if(\Illuminate\Support\Facades\Route::has('admin.settings.edit')): ?>
                <a href="<?php echo e(route('admin.settings.edit')); ?>" class="<?php echo e($linkBase); ?> <?php echo e($isActive('admin.settings.*') ? $linkActive : $linkInactive); ?>">
                    <svg class="h-4 w-4 flex-none <?php echo e($isActive('admin.settings.*') ? $iconActive : $iconInactive); ?>" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            ...
            <?php if(\Illuminate\Support\Facades\Route::has('admin.ai-agent.edit')): ?>
                <a href="<?php echo e(route('admin.ai-agent.edit')); ?>" class="<?php echo e($linkBase); ?> <?php echo e($isActive('admin.ai-agent.*') ? $linkActive : $linkInactive); ?>">
                    <svg class="h-4 w-4 flex-none <?php echo e($isActive('admin.ai-agent.*') ? $iconActive : $iconInactive); ?>" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                        <path d="M12 2.25a.75.75 0 0 1 .75.75v1.08a7.5 7.5 0 0 1 2.18.9l.77-.77a.75.75 0 0 1 1.06 0l1.06 1.06a.75.75 0 0 1 0 1.06l-.77.77c.39.68.68 1.42.85 2.2H19.5a.75.75 0 0 1 .75.75v1.5a.75.75 0 0 1-.75.75h-1.08a7.5 7.5 0 0 1-.9 2.18l.77.77a.75.75 0 0 1 0 1.06l-1.06 1.06a.75.75 0 0 1-1.06 0l-.77-.77a7.5 7.5 0 0 1-2.2.85V21a.75.75 0 0 1-.75.75h-1.5A.75.75 0 0 1 10.5 21v-1.08a7.5 7.5 0 0 1-2.18-.9l-.77.77a.75.75 0 0 1-1.06 0L5.43 18.5a.75.75 0 0 1 0-1.06l.77-.77a7.5 7.5 0 0 1-.85-2.2H4.5a.75.75 0 0 1-.75-.75v-1.5a.75.75 0 0 1 .75-.75h1.08a7.5 7.5 0 0 1 .9-2.18l-.77-.77a.75.75 0 0 1 0-1.06l1.06-1.06a.75.75 0 0 1 1.06 0l.77.77a7.5 7.5 0 0 1 2.2-.85V3a.75.75 0 0 1 .75-.75H12Zm0 6a3.75 3.75 0 1 0 0 7.5 3.75 3.75 0 0 0 0-7.5Z"/>
                    </svg>
                    <span>AI Agent</span>
                </a>
...
<?php if ($__env->exists('admin.partials.ai-popup')) echo $__env->make('admin.partials.ai-popup', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</body>
</html>
