...
<div class="impart-form" id="<?php echo e($formId); ?>">
    
    <form method="POST" action="<?php echo e(route('forms.submit', ['form' => $form->slug])); ?>">
        <?php echo csrf_field(); ?>
        ...
        ?>
        <?php if(!empty($toValue)): ?>
            <input type="hidden" name="_impart_to" value="<?php echo e($toValue); ?>">
        <?php endif; ?>

        <?php if(!empty($ccValue)): ?>
            <input type="hidden" name="_impart_cc" value="<?php echo e($ccValue); ?>">
        <?php endif; ?>

        <?php if(!empty($bccValue)): ?>
            <input type="hidden" name="_impart_bcc" value="<?php echo e($bccValue); ?>">
        <?php endif; ?>
        ...
        <?php if((bool)($pricing['enabled'] ?? false)): ?>
        ...
        <?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $si => $blocks): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div data-impart-step style="<?php echo e($si === 0 ? '' : 'display:none'); ?>">
                <?php $__currentLoopData = $blocks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $block): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="grid <?php echo e($gridClass); ?>" style="margin-bottom:14px">
                        <?php for($ci=0; $ci<$cols; $ci++): ?>
                            <div>
                                <?php
                                    $fieldIds = $fbColFields($colsArr[$ci] ?? []);
                                ?>
                                <?php $__currentLoopData = $fieldIds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fidRaw): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    ...
                                    ?>
                                    <?php if(!$field): ?> <?php continue; ?> <?php endif; ?>
                                    ...
                                    <div class="impart-field">
                                        ...
                                        <?php if(in_array($type, ['text','email'])): ?>
                                            <input type="<?php echo e($type); ?>" name="<?php echo e($name); ?>" placeholder="<?php echo e($placeholder); ?>" <?php echo e($required ? 'required' : ''); ?>>

                                        <?php elseif($type === 'textarea'): ?>
                                            <textarea name="<?php echo e($name); ?>" rows="4" placeholder="<?php echo e($placeholder); ?>" <?php echo e($required ? 'required' : ''); ?>></textarea>

                                        <?php elseif($type === 'phone'): ?>
                                            <div style="display:flex; gap:10px; align-items:stretch">
                                                <select name="<?php echo e($name); ?>_country" data-impart-phone-country style="width:72px; font-size:22px; padding:8px 10px;">
                                                ...
                                                <input type="tel" name="<?php echo e($name); ?>" placeholder="<?php echo e($placeholder ?: 'Phone number'); ?>" <?php echo e($required ? 'required' : ''); ?>>
                                            </div>

                                        <?php elseif($type === 'select'): ?>
                                            <select name="<?php echo e($name); ?>" <?php echo e($required ? 'required' : ''); ?>>
                                        ...
                                        <?php elseif(in_array($type, ['cards','cards_multi'])): ?>
                                            <?php $isMulti = $type === 'cards_multi'; ?>
                                            <div class="cards" data-impart-cards>
                                                <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $oi => $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php
                                                    ...
                                                    <label class="card" for="<?php echo e($id); ?>" data-impart-card>
                                                        <span class="card-media"><?php echo $media; ?></span>
                                                        <span style="flex:1">
                                                            <span class="card-title"><?php echo e($ol); ?></span>
                                                        </span>
                                                        <input id="<?php echo e($id); ?>" type="<?php echo e($isMulti ? 'checkbox' : 'radio'); ?>" name="<?php echo e($isMulti ? $name.'[]' : $name); ?>" value="<?php echo e($ov); ?>" style="width:auto" <?php echo e($required && !$isMulti ? 'required' : ''); ?>>
                                                    </label>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </div>

                                        <?php else: ?>
                                            <input type="text" name="<?php echo e($name); ?>" placeholder="<?php echo e($placeholder); ?>" <?php echo e($required ? 'required' : ''); ?>>
                                        <?php endif; ?>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                ...
                <?php if($hasSteps): ?>
                    <div class="wizard-nav">
                        <button type="button" class="btn" data-impart-prev <?php echo e($si === 0 ? 'disabled' : ''); ?>>Back</button>
...
<script>
(function(){
    const root = document.getElementById(<?php echo json_encode($formId, 15, 512) ?>);
    if (!root) return;
