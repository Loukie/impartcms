     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                <a href="<?php echo e(route('admin.pages.ai.create')); ?>"
                   class="inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-md font-semibold text-xs text-gray-900 uppercase tracking-widest hover:bg-gray-50">
                    AI Page
                </a>

                <?php if(\Illuminate\Support\Facades\Route::has('admin.site-builder.create')): ?>
                    <a href="<?php echo e(route('admin.site-builder.create')); ?>"
                       class="inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-md font-semibold text-xs text-gray-900 uppercase tracking-widest hover:bg-gray-50">
                        AI Site Builder
                    </a>
                <?php endif; ?>

                <?php if(\Illuminate\Support\Facades\Route::has('admin.pages.clearHomepage')): ?>
                    <form method="POST" action="<?php echo e(route('admin.pages.clearHomepage')); ?>" class="inline"
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form method="POST" action="<?php echo e(route('admin.pages.bulk')); ?>" id="bulkForm" onsubmit="return confirm('Move selected pages to trash?');">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-3 py-2 whitespace-nowrap font-medium text-gray-900">
                                            ...
                                            <?php if($page->is_homepage): ?>
                                                <span class="ml-2 text-xs px-2 py-0.5 rounded border
                                                    ...
                                                    <?php echo e($page->status === 'published' ? 'Home' : 'Home (draft)'); ?>
                                        ...
                                        <td class="px-3 py-2 whitespace-nowrap text-right">
                                            <div class="flex items-center justify-end gap-4">
                                                ...
                                                <?php if($page->is_homepage): ?>
                                                    <form method="POST" action="<?php echo e(route('admin.pages.unsetHomepage', $page)); ?>" class="inline"
                                                ...
                                                <?php elseif($page->status === 'published'): ?>
