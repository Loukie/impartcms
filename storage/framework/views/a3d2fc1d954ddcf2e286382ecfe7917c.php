        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form method="POST" action="<?php echo e(route('admin.users.bulk')); ?>" id="bulkForm" onsubmit="return confirm('Move selected users to trash?');">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td class="px-3 py-2 whitespace-nowrap">
                                        <input type="checkbox" name="ids[]" value="<?php echo e($user->id); ?>" class="bulk-checkbox" />
                                    </td>
                                    ...
                                    <td class="px-3 py-2 whitespace-nowrap text-right">
                                        <div class="flex items-center justify-end gap-4">
                                            ...
                                            <?php else: ?>
                                                <span class="text-gray-400 font-semibold text-sm cursor-not-allowed"
                                                      title="<?php echo e(auth()->id() === $user->id ? 'You can’t trash yourself.' : 'You can’t trash the last admin.'); ?>">
                                                    Trash
                                                </span>
                                            <?php endif; ?>
                                        </div>
